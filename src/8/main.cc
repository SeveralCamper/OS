...
int main() {
    ...
    std::cout << std::fixed << "Time without threads: " << time << " nanoseconds" << std::endl;
    auto no_threads_sum = sum;
    sum = 0;
    time = calculating_with_posix_threads();
    std::cout << std::fixed << "Time with posix threads: " << time << " nanoseconds" << std::endl;
    auto posix_threads_sum = sum;
    sum = 0;
    time = calculating_with_std_threads();
    std::cout << std::fixed << "Time with std threads: " << time << " nanoseconds" << std::endl;
